...
class ReportProductTemplateLabel(models.AbstractModel):
    _name = 'report.bista_product_label.report_producttemplatelabel'
    _description = 'Product Label Report'

    def _get_report_values(self, docids, data):
        res = _prepare_data(self.env, data)
        IrParamSudo = self.env['ir.config_parameter'].sudo()

        print_label_qr_code_settings = IrParamSudo.get_param('bista_product_label.use_qr_code_print_label')
...
class ReportProductTemplateLabelDymo(models.AbstractModel):
    _name = 'report.bista_product_label.report_producttemplatelabel_dymo'
    _description = 'Product Label Report'
