odoo.define('bi_pos_reports.XMLPosProductSummaryReceipt', function(require) {
	'use strict';
	...
	class XMLPosProductSummaryReceipt extends PosComponent {
		...
		save_product_summery_details(output_summery_product, pro_st_date, pro_ed_date,prod_current_session){
			console.log(this,"==save_product_summery_details")
			var self = this;
			...
			console.log(self.get_product_receipt_render_env())
		}
		...
		get_pro_summery(){
			...
			console.log(output_summery_product['props']['output_summery_product'],"====get_pro_summery")
		...
		get_product_st_date(){
			...
			console.log(pro_st_date['props']['pro_st_date'],"=======get_product_st_date")
