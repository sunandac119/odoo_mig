odoo.define('bi_pos_reports.PaymentReceiptWidget', function(require) {
    ...
    // class PaymentReceiptWidget extends PosComponent {
	        constructor() {
	            super(...arguments);
	            this.get_payment_receipt_render_env();
	            console.log(this,"================PaymentReceiptWidget")
   ...
   //      payment_render_reciept(){
   //      	var rendered_html = this.env.pos.config.customer_facing_display_html;
   //      	var $rendered_html = $(rendered_html);
   //      	// var get_payment_receipt_render_env = this.get_payment_receipt_render_env();
   //      	// var render_payment_receipt = QWeb.render('XMLPosPaymentSummaryReceipt', get_payment_receipt_render_env)
			// $rendered_html.find('.pos-payment-receipt').html(QWeb.render('XMLPosPaymentSummaryReceipt', this.get_payment_receipt_render_env()));
			// }

		get_payment_receipt_render_env() {
			var self = this;
			var is_current = this.env.pos.get_order().get_screen_data('is_current_session')
			// console.log(is_current['props']['payments'],"------is_current")
		...
		get_payment_summery(){
			...
			// console.log(payment_summary['props']['payment_summary'])
