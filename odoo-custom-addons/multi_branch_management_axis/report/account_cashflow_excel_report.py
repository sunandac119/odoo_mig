...
class ReportAccountCashFlowExcel(models.TransientModel):
    _name = 'report.multi_branch_management_axis.report_excel_cashflow'
    _description = 'Account Cashflow excel report model'
