...
class LabelPrintWizard(models.TransientModel):
    ...
    image_width = fields.Float("Width", default=100)
    image_height = fields.Float("Height", default=100)
    barcode_width = fields.Float("Width", default=200)
    barcode_height = fields.Float("Height", default=80)
