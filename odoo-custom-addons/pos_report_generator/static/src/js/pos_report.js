		...
		load_data: function(initial_render = true) {
			...
			self._rpc({
				...
				if (initial_render) {
					...
					self.$el.find('.pointofsale').select2();
...
//				filter_data_selected.pos_config_id = $(".pointofsale").val()
				filter_data_selected.pos_config_ids = $("#pointofsale_selection").val()
...
//				if ($(".pointofsale").val() == "") {
//					filter_data_selected.pos_config_id = false;
//				}

				if($("#pointofsale_selection").length && $("#pointofsale_selection").val().length){
			        filter_data_selected.pos_config_ids = $("#pointofsale_selection").val()
                }else{
                    filter_data_selected.pos_config_ids = false
                }
